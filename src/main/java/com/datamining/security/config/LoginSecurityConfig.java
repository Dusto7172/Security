...
public class LoginSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public void configureGlobal1(AuthenticationManagerBuilder authenticationMgr) throws Exception {
		authenticationMgr.inMemoryAuthentication().withUser("QA").password("qa@123").authorities("ROLE_USER");
	}
	
	@Autowired
	public void configureGlobal2(AuthenticationManagerBuilder authenticationMgr) throws Exception {
		authenticationMgr.inMemoryAuthentication().withUser("UAT").password("uat@123").authorities("ROLE_USER");
	}
	
	@Autowired
	public void configureGlobal3(AuthenticationManagerBuilder authenticationMgr) throws Exception {
		authenticationMgr.inMemoryAuthentication().withUser("SIT").password("sit@123").authorities("ROLE_USER");
	}
